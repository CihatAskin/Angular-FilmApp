...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    const movies = [
      ...
      { id: 2, name: "movie 2", description: "Not Bad", imageUrl: "godFather.jpg" },
      { id: 3, name: "movie 3", description: "Not Bad", imageUrl: "godFather.jpg" },
      { id: 4, name: "movie 4", description: "Not Bad", imageUrl: "godFather.jpg" },
      { id: 5, name: "movie 5", description: "Not Bad", imageUrl: "godFather.jpg" },
      { id: 6, name: "movie 6", description: "Not Bad", imageUrl: "godFather.jpg" }
